...
import ReviewsCard from "../Review/ReviewCard";
import bussinessImage from "../../../public/assets/bussiness.jpg";
...
const Reviews = () => {
  return (
    <div className={`${styles.label} w-[90%] 800px:w-[85%] m-auto mt-30!`}>
      <div className="w-full 800px:flex items-center gap-10">
        {/* Left Side */}
        <div className="w-full 800px:w-[50%]">
          <Image src={bussinessImage} alt="business" width={500} height={500} />
        </div>
        {/* Right  Side */}
        <div className="w-full  800px:[w-50%]">
          <div>
         ...
         <div>
            <p className={styles.label}>
              Join thousands of developers and tech professionals who trust our
              platform to upgrade their skills. Every curriculum is vetted by
              industry experts to ensure you are learning the most up-to-date,
