...
const Hero = () => {
  ...
  const { data, isLoading: dataLoading } = useGetLayoutDataQuery("Banner", {});
              ...
              <div className="w-full max-w-lg mb-10 relative group">
                <div className="relative flex items-center shadow-lg dark:shadow-none rounded-full bg-white dark:bg-gray-800 ring-1 ring-gray-200 dark:ring-gray-700 focus-within:ring-2 focus-within:ring-blue-500 transition-all">
                  ...
                  <button
                    ...
                    className="absolute cursor-pointer right-1.5 top-1.5 bottom-1.5 w-12 flex items-center justify-center bg-blue-600 rounded-full hover:bg-blue-700 transition-colors shadow-md"
                  >
              ...
              <div className="flex flex-col sm:flex-row items-center lg:items-start gap-4">
                ...
                <div className="mt-3">
                  <p className="text-sm md:text-base text-gray-600 dark:text-gray-400">
                    ...
                    <Link
                      href="/courses"
                      className="text-blue-600 dark:text-blue-400 font-medium hover:underline hover:text-blue-700 transition-colors"
                    >
