      ...
      <div className="w-[95%] 800px:w-full 800px:max-w-[85%] mx-auto px-2 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 md:grid-cols-4">
          ...
          <div className="space-y-3 font-Poppins">
            ...
            <ul className="space-y-4">
              ...
              <li>
                <Link
                  className="text-base text-black dark:text-gray-300 dark:hover:text-white pb-2"
                  href="https://github.com/Ahmadkhaan08"
                >
                  Github
                </Link>
              </li>
          ...
          <div className="font-Poppins">
            ...
            <Link
              className=" text-white font-Poppins font-semibold py-2 px-4 rounded inline-block bg-linear-to-r from-blue-600 to-purple-600 dark:from-blue-600 dark:to-purple-600"
              href={`mailto:mrahmadismail13@gmail.com`}
            >
              Connect
            </Link>
          </div>
        ...
        <br />
        <p className="text-center font-Poppins text-black dark:text-white">
