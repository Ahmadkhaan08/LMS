...
const ReviewCard: FC<Props> = ({ item }) => {
    return (
        <div className="w-full h-max pb-4 mt-4 dark:bg-slate-900 dark:bg-opacity-20 backdrop-blur border dark:border-[#ffffff1d] border-[#00000015] dark:shadow-[bg-slate-700] rounded-lg p-3 shadow-sm dark:shadow-inner">
