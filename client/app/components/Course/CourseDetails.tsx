      ...
      <div className="w-full flex flex-col-reverse 800px:flex-row">
        ...
        <div className="w-full 800px:w-[65%] 800px:pr-5">
          ...
          <div className="w-full">
            ...
            <p className="text-[18px] font-Poppins mt-5 whitespace-pre-line w-full overflow-hidden text-black dark:text-white">
              {data.description}
            </p>
          </div>
          <br />
        ...
        <div className="w-full 800px:w-[35%] relative">
          ...
          <div className="sticky top-[100px] left-0 z-50 w-full">
            ...
            <div className="flex items-center">
              <h1 className="pt-5 text-[25px] text-black dark:text-white font-Poppins">
                {data.price === 0 ? "Free" : data.price + "$"}
              </h1>

              <h5 className="pl-3 text-[20px] mt-2 line-through opacity-80 text-black dark:text-white font-Poppins">
                {data.estimatedPrice}$
              </h5>
              <h4 className="pl-5 pt-4 text-[22px] text-black dark:text-white font-Poppins">
